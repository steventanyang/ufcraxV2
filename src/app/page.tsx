    ...
    <main className="min-h-screen bg-[#111111] text-gray-100">
      <div className="fixed top-4 right-4 flex items-center gap-2">
        <button
          ...
          className="text-gray-400 hover:text-gray-200 text-sm font-medium transition-colors duration-200 mr-3"
        >
          Changelog
        </button>
        <a
          ...
          className="flex items-center gap-2 bg-[#2a2a2a] hover:bg-[#333333] text-gray-300 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200"
        >
          <svg
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="pt-12 md:pt-16 pb-6 md:pb-8">
          ...
          <div className="text-gray-500 text-center text-xs md:text-base mb-6">
            <p>
              join &quot;UFC Rax group&quot; for feedback / bug reports - made
              by @yangsl
            </p>
          </div>
